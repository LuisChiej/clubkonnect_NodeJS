...
var Club = /** @class */ (function () {
    ...
    Club.prototype.balance_request = function (path) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            request("https://nellobytesystems.com/" + path + ".asp?UserID=" + _this.getuserId() + "&APIKey=" + _this.getapiKey(), { json: true }, function (err, res) {
                if (err) {
                    reject(err);
                }
                resolve(res);
